...
int main()
{
    ...
    nml
    {
        ...
        rep1(i, 999)
        {
            ...
            if(bool(mp1[x]) + bool(mp2[y]) + bool(mp3[z]) == c)
                    continue ;
            else if(bool(mp1[x]) + bool(mp2[z]) + bool(mp3[y]) == c)
                    continue ;
            else if(bool(mp1[y]) + bool(mp2[x]) + bool(mp3[z]) == c)
                    continue ;
            else if(bool(mp1[y]) + bool(mp2[z]) + bool(mp3[x]) == c)
                    continue ;
            else if(bool(mp1[z]) + bool(mp2[x]) + bool(mp3[y]) == c)
                    continue ;
            else if(bool(mp1[z]) + bool(mp2[y]) + bool(mp3[x]) == c)
                    continue ;
            else
                break;
        }
